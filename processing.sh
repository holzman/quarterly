...
convert -extent 720x604+0-100 tape_verified_delay_plot-90.jpg \
    ...
    -strokewidth 1 \
    -fill red -stroke red \
    -draw "translate 0,320 stroke-width 3 line 70,0 700,0 stroke-width 1 text 100,-10 '12 Hour Goal'" \
...
convert cms_farm_usgae.jpg \
    ...
    -pointsize 18 \
    -draw "translate 150, 100 text 0,0 'LPC Analysis' text 30, 20 'Jobs'" \
...
convert processing-share.png \
    -fill \#f91b85 -stroke \#f91b85 \
    -pointsize 24 \
    -draw "translate 645,85 text 0, 0 'FNAL' translate -80,70 rotate 135 $pointer " \
...
convert utilization_pledged.png \
    -fill \#679819 -stroke \#679819 \
    -pointsize 18 \
    -draw "translate 670,260 text -65, 10 'FNAL' translate -80,170 rotate 105 scale 1.5,1 $pointer " \
    -strokewidth 3 \
    -fill red -stroke red -strokewidth 5\
    -draw "translate 0, 470 line 100,0 718,0" \
    -strokewidth 1 \
    -draw "translate 500,385 text -90, -115 '100% utilization' translate -80,70 rotate 105 scale 1.75,1 $pointer " \
...
\
    ...
    -draw "fill magenta stroke magenta translate 500,240 text 0, 0 'Users'  scale .5,.5 translate 190,-80 rotate -30 $pointer " \
